...
// Create a list of places
        ...
        places.add(new Place(R.string.roberto_restaurant,R.string.italian,R.drawable.roberto_italian_restaurant
                ,R.string.about_italian_restuarant,R.string.italian_restaurant_opening
                ,R.string.italian_restuarant_number,R.string.italian_restaurant_address));
